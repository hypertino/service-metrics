...
pomExtra := <url>https://github.com/InnovaCo/service-metrics</url>
  <licenses>
    <license>
      <name>BSD-style</name>
  ...
  <scm>
    <url>git@github.com:InnovaCo/service-metrics.git</url>
    <connection>scm:git:git@github.com:InnovaCo/service-metrics.git</connection>
  </scm>
  <developers>
    <developer>
      <id>InnovaCo</id>

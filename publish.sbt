...
pomExtra :=
  <url>https://github.com/hypertino/service-metrics</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/service-metrics.git</url>
      <connection>scm:git:git@github.com:hypertino/service-metrics.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
